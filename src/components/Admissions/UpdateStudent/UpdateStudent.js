...
const UpdateStudent = ({ studentApplicants, removeStudentApplicant }) => {
  ...
  return (
    <Container fluid>
      ...
      <SearchBar placeholder="Search functionality currently not available for this table!!" />
      <TableList
...
const mapDispatchToProps = (dispatch) => ({
  removeStudentApplicant: ({ studentApplicants, studentApplicant }) =>
    dispatch(removeStudentApplicant(studentApplicants, studentApplicant)),
});
